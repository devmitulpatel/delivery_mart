...
@section('content')
    <div class="page-content">
        ...
        <div class="card" style="margin-bottom:5px;padding:5px;">
            <form method="POST" action="/admin/deliveryFeeModify">
                @csrf
                <label>Delivery fee per km</label>
                <input type="number" class="form" name="deliveryFee" value="{{ Storage::get('deliveryFee.txt') }}">
                <input type="submit" class="btn btn-primary" value="change">
            </form>
        </div>
        @include('vendor.voyager.contact')
